...
import 'package:api_methods/app_button.dart';
import 'package:api_methods/base_client.dart';
import 'package:api_methods/user.dart';
              ...
              AppButton(
                ...
                onPressed: () async {
                  var user = User(
                    name: 'ABC',
                    qualifications: [
                      Qualification(degree: 'B.Tech', completionData: '01-01-2025'),
                    ],
                  );
